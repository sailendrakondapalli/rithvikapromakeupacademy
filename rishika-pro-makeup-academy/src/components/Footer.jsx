    ...
    <footer className="footer">
      <div className="footer-top">
        <div className="footer-brand">
          <h3>Rishika Pro Makeup Academy</h3>
          ...
          <div className="footer-socials">
            ...
            <a
              href="https://wa.me/917075928104?text=Hi%20I%20am%20interested%20in%20your%20services"
              target="_blank"
              rel="noreferrer"
              aria-label="WhatsApp"
              className="social-icon"
      ...
      <div className="footer-bottom">
        <p>© 2024 Rishika Pro Makeup Academy. All rights reserved.</p>
